                    ...
                    <div className='xl:relative'>
                        ...
                        <div className='xl:absolute xl:inset-8  space-y-5 xl:w-1/3'>
                            ...
                            <div className='xl:flex hidden'>
                                <a href="#_" class="bg-slate-800 relative inline-flex items-center justify-center p-3 px-4 py-2 overflow-hidden font-medium text-white transition duration-300 ease-out border-2 border-indigo-900 rounded-full shadow-md group">
